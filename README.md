...
| **`lab02`** | **Захист особистих повідомлень** | Модульний проєкт (Python), `README.md`, `requirements.txt`, Файли скріншотів |
| **`lab03`** | **Невидимі дані у власних файлах** | Модульний проєкт (Python), `README.md`, `requirements.txt`, Файли скріншотів |
| **`lab04`** | **Особистий цифровий підпис** | Програма з GUI (Python), `README.md`, Файли скріншотів |
| **`lab05`** | **Захищена електронна пошта** | Програма з GUI (Python), `README.md`, Файли скріншотів |
| **`lab06`** | **Етичний хакінг власного застосунку** | Програма з GUI (Python), `README.md`, Файли скріншотів |
| **`lab07`** | **Комплексний захист особистого проекту** | Програма з GUI (Python), `README.md`, Файли скріншотів |
